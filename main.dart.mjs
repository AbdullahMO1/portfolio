...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1301: x0 => x0.play(),
      _1302: x0 => x0.pause(),
      _1310: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1311: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1312: (x0,x1) => x0.createElement(x1),
      _1318: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1319: x0 => x0.decode(),
      _1320: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1321: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1324: x0 => x0.send(),
      _1325: () => new XMLHttpRequest(),
      _1326: () => new AudioContext(),
      _1327: (x0,x1) => x0.createMediaElementSource(x1),
      _1328: x0 => x0.createStereoPanner(),
      _1329: (x0,x1) => x0.connect(x1),
      ...
      _1353: x0 => new WeakRef(x0),
      _1354: x0 => x0.deref(),
      _1361: () => globalThis.WeakRef,
      _1365: s => JSON.stringify(s),
      _1366: s => printToConsole(s),
      _1367: (o, p, r) => o.replaceAll(p, () => r),
      _1369: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1370: s => s.toUpperCase(),
      _1371: s => s.trim(),
      _1372: s => s.trimLeft(),
      _1373: s => s.trimRight(),
      _1374: (string, times) => string.repeat(times),
      _1375: Function.prototype.call.bind(String.prototype.indexOf),
      _1376: (s, p, i) => s.lastIndexOf(p, i),
      _1377: (string, token) => string.split(token),
      _1378: Object.is,
      _1382: (o, c) => o instanceof c,
      _1383: o => Object.keys(o),
      ...
      _1462: x0 => x0.random(),
      _1463: (x0,x1) => x0.getRandomValues(x1),
      _1464: () => globalThis.crypto,
      ...
      _1517: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1517(f,arguments.length,x0,x1) }),
      _1518: o => {
      ...
      _1567: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1567(f,arguments.length,x0,x1,x2) }),
      _1568: (x0,x1) => x0.forEach(x1),
      _1569: x0 => x0.getReader(),
      _1570: x0 => x0.cancel(),
      _1571: x0 => x0.read(),
      _1575: o => o instanceof Array,
      _1576: (a, i) => a.push(i),
      _1580: a => a.pop(),
      _1581: (a, i) => a.splice(i, 1),
      _1582: (a, s) => a.join(s),
      _1583: (a, s, e) => a.slice(s, e),
      _1586: a => a.length,
      _1588: (a, i) => a[i],
      _1589: (a, i, v) => a[i] = v,
      _1591: o => {
      ...
      _1592: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1594: o => o instanceof Uint8Array,
      _1595: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1596: o => o instanceof Int8Array,
      _1597: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1598: o => o instanceof Uint8ClampedArray,
      _1599: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1600: o => o instanceof Uint16Array,
      _1601: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1602: o => o instanceof Int16Array,
      _1603: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1604: o => o instanceof Uint32Array,
      _1605: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1606: o => o instanceof Int32Array,
      _1607: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1609: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1610: o => o instanceof Float32Array,
      _1611: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1612: o => o instanceof Float64Array,
      _1613: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1614: (t, s) => t.set(s),
      _1615: l => new DataView(new ArrayBuffer(l)),
      _1616: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1618: o => o.buffer,
      _1619: o => o.byteOffset,
      _1620: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1621: (b, o) => new DataView(b, o),
      _1622: (b, o, l) => new DataView(b, o, l),
      _1623: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1624: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1625: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1626: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1627: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1628: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1629: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1630: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1631: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1632: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1633: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1634: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1637: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1638: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1639: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1640: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1641: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1642: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1643: Function.prototype.call.bind(Number.prototype.toString),
      _1644: Function.prototype.call.bind(BigInt.prototype.toString),
      _1645: Function.prototype.call.bind(Number.prototype.toString),
      _1646: (d, digits) => d.toFixed(digits),
      _1672: () => globalThis.document,
      _1678: (x0,x1) => { x0.height = x1 },
      _1680: (x0,x1) => { x0.width = x1 },
      _1682: (x0,x1) => { x0.pointerEvents = x1 },
      _1691: x0 => x0.style,
      _1694: x0 => x0.src,
      _1695: (x0,x1) => { x0.src = x1 },
      _1696: x0 => x0.naturalWidth,
      _1697: x0 => x0.naturalHeight,
      _1713: x0 => x0.status,
      _1714: (x0,x1) => { x0.responseType = x1 },
      _1716: x0 => x0.response,
      _2446: x0 => x0.error,
      _2448: (x0,x1) => { x0.src = x1 },
      _2453: (x0,x1) => { x0.crossOrigin = x1 },
      _2456: (x0,x1) => { x0.preload = x1 },
      _2460: x0 => x0.currentTime,
      _2461: (x0,x1) => { x0.currentTime = x1 },
      _2462: x0 => x0.duration,
      _2467: (x0,x1) => { x0.playbackRate = x1 },
      _2476: (x0,x1) => { x0.loop = x1 },
      _2480: (x0,x1) => { x0.volume = x1 },
      _2497: x0 => x0.code,
      _2498: x0 => x0.message,
